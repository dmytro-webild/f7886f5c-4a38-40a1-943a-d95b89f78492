...
export default function LandingPage() {
      ...
      mediaItems={[
        {
          ...
          imageAlt: "Modern PVC window installation in a home interior",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-people-working-together_23-2149366697.jpg",
          imageAlt: "Skilled construction team installing a new door",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/renovation-concept_1098-19446.jpg",
          imageAlt: "Renovation concept",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-worker-uniform-with-hard-hat-protective-gloves_23-2148773463.jpg",
          imageAlt: "Side view of worker in uniform with hard hat and protective gloves",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/enjoying-morning-sun-before-start-work_329181-11779.jpg",
          imageAlt: "Enjoying of morning sun before start the work",
        },
      ]}
      ...
      features={[
        {
          ...
          subtitle: "Tailored PVC & Aluminum solutions to match your unique architectural style and functional needs.",
        ...
        },
        {
          ...
          subtitle: "Our certified technicians ensure flawless and secure installation, guaranteeing durability and performance.",
          category: "Service",
          value: "Reliability",
        },
        {
          ...
          subtitle: "Upgrade to high-performance doors and windows that enhance insulation and reduce energy costs.",
          category: "Innovation",
          value: "Savings",
        },
      ]}
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          imageAlt: "Large aluminum sliding door",
        },
        {
          id: "pvc-window-double",
          name: "PVC Double Glazed Window",
          price: "Custom Quote",
          imageSrc: "http://img.b2bpic.net/free-photo/white-door-with-rhythmic-square-panels-minimalist-facade-bright-geometric-doorway_169016-71058.jpg",
          imageAlt: "Double glazed PVC window",
        },
        {
          id: "aluminum-panoramic",
          name: "Aluminum Panoramic Window",
          price: "Custom Quote",
          imageSrc: "http://img.b2bpic.net/free-photo/glass-window-overlooking-green-garden_1232-2979.jpg",
          imageAlt: "Large panoramic aluminum window",
        },
        {
          id: "pvc-door-custom",
          name: "Custom Design PVC Door",
          price: "Custom Quote",
          imageSrc: "http://img.b2bpic.net/free-photo/light-doors-with-green-accents-soft-arched-panels-cream-classic-doors_169016-70925.jpg",
          imageAlt: "Custom colored PVC door",
        },
        {
          id: "aluminum-security",
          name: "Security Aluminum Window",
          price: "Custom Quote",
          imageSrc: "http://img.b2bpic.net/free-photo/abstract-city-building-shadows_23-2149283302.jpg",
          imageAlt: "Security reinforced aluminum window",
        },
      ]}
      ...
      testimonials={[
        {
          id: "1",
          name: "Ahmed Karim",
          handle: "@AhmedKarimErbil",
          testimonial: "Daroj PVC did an outstanding job on our home windows. The quality is exceptional and the installation was quick and professional. Highly recommend!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/stylish-girl-sitting-restaurant_8353-7822.jpg",
          imageAlt: "Portrait of Ahmed Karim",
        },
        {
          id: "2",
          name: "Lana Ali",
          handle: "@LanaAliProperties",
          testimonial: "As a property manager, I need reliability. Daroj PVC delivered on time and within budget for a commercial project. Their aluminum doors are top-notch.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/businessman-standing-outside-office-building-talking-speaker-mobile-phone_23-2147972815.jpg",
          imageAlt: "Portrait of Lana Ali",
        },
        {
          id: "3",
          name: "Omar Hassan",
          handle: "@OmarHassanConst",
          testimonial: "Their custom PVC solutions are a game-changer. Excellent craftsmanship and the team was very communicative throughout the entire process.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-woman-with-short-curly-hair-making-frame-with-fingers-looking-through-this-frame-smiling-cheerfully-standing-pink-wall_141793-29278.jpg",
          imageAlt: "Portrait of Omar Hassan",
        },
        {
          id: "4",
          name: "Sarah Jafar",
          handle: "@SarahJafarHomes",
          testimonial: "From consultation to final installation, Daroj PVC was a pleasure to work with. Our new windows look fantastic and are so energy-efficient!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/crazy-businessman-happy-expression_1194-3548.jpg",
          imageAlt: "Portrait of Sarah Jafar",
        },
        {
          id: "5",
          name: "Faris Murad",
          handle: "@FarisMuradDev",
          testimonial: "We've used Daroj PVC for several development projects. Their consistency in quality and commitment to deadlines makes them our go-to partner.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/business-woman-smiling-with-top-hat-thumbs-up_1187-1549.jpg",
          imageAlt: "Portrait of Faris Murad",
        },
      ]}
      showRating={true}
  ...
  <div id="socialProof" data-section="socialProof">
      ...
      useInvertedBackground={false}
      names={[
        "Erbil Developers Group",
        "Kurdish Homes Ltd.",
        "Al-Amal Construction",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "What types of materials do you specialize in?",
          content: "Daroj PVC specializes in custom PVC and aluminum doors, windows, and related installation services. We ensure high-quality, durable materials for all our projects.",
        },
        {
          id: "q2",
          title: "Do you offer custom designs for doors and windows?",
          content: "Yes, we offer bespoke design services to create custom PVC and aluminum doors and windows that perfectly match your aesthetic and functional requirements.",
        },
        {
          id: "q3",
          title: "What is your service area?",
          content: "We primarily serve the greater Erbil region, including residential and commercial properties within the city and surrounding areas.",
        },
      ]}
